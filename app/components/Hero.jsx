    ...
    return (
        <div>
            ...
            <div className="mx-auto flex flex-col  md:flex-row px-6 md:space-x-6 items-center">
                <div className="md:w-1/2 mt-7 flex flex-col space-y-6 justify-center py-6  text-start dark:text-white text-black">
                <div>WELCOME TO MY WORLD</div>
                    <h1 className='font-bold text-5xl'>
                        Hi, I&apos;m  <span className="dark:text-purple-500 text-purple-700">Yossef Diaa</span>
                    </h1>
